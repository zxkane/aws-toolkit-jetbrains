...
object AwsIcons {
    ...
    object Resources {
        ...
        object CloudWatch {
            @JvmField val LOGS = IconLoader.getIcon("/icons/resources/CloudWatchLogs.svg") // 16x16
            @JvmField val LOGS_GROUP = IconLoader.getIcon("/icons/resources/CloudWatchLogsGroup.svg") // 16x16
        }
