...
class ExecutableLoader2 : StartupActivity, DumbAware {
    override fun runActivity(project: Project) {
        ExecutableManager2.getInstance()
    }
}
...
interface ExecutableManager2 {
    ...
    companion object {
        @JvmStatic
        fun getInstance(): ExecutableManager2 = ServiceManager.getService(ExecutableManager2::class.java)
    }
}
